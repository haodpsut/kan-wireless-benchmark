...
with median $R^2=0.998$), but distilling them into that symbolic form costs
$\input{claims/interp_degradation_db}$~dB of NMSE: the interpretable model is not the
performant one.}
\label{fig:interp}
\end{figure}
...
wins only at low SNR, while the spline-KAN overtakes it above $\sim\input{claims/snr_crossover_db}$~dB. Reporting a single
